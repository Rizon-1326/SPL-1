...
int main()
{
    ...
    cout<<"4.Help"<<endl;
    pos;
    cout<<"5. Graphical view OfSpeed"<<endl;
    pos;
    cout<<"6.Graphical view Of Accuracy"<<endl;
    pos;
    cout<<"7.Block Diagram of speed"<<endl;
    pos;
    cout<<"8.Block Diagram of Accuracy"<<endl;
    pos;
    cout<<"9.About me"<<endl;
    pos;
    cout<<"0.Exit"<<endl;
    pos;
